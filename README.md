...
냉장고를 정리해는 유통기한을 기반으로 사용자의 냉장고 속 식품을 관리하는 어플리케이션입니다. 사진을 찍는 것만으로 간편하게 입력할 수 있고 유통기한이 얼마 남지 않은 식품들을 PUSH 알림을 통해 확인할 수 있습니다. 또한, 다양한 레시피 제공을 통해 사용자가 식품을 소비하는데 도움을 줍니다. 언제 어디서든 냉장고에 무엇이 있고 유통기한이 얼마나 남았는지 확인할 수 있어 불필요한 식품 소비를 줄이고 환경도 보호할 수 있습니다.
